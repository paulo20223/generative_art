...
def setup():
    ...
    for e in white_list:
        ...
        if e[1] < grid_h - 1:
            if grid[e[0]][e[1] + 1] != 1:
                stroke(0)
                line(e[0] * tile_size, e[1] * tile_size + tile_size, e[0] * tile_size + tile_size,
                     e[1] * tile_size + tile_size)
    ...
    for e in white_list:
        ...
        if e[0] < grid_w - 1:
            if grid[e[0] + 1][e[1]] != 1 and grid[e[0] + 1][e[1]] != 6:
                stroke(cl[0], cl[1], cl[2])
                line(e[0] * tile_size + tile_size, e[1] * tile_size, e[0] * tile_size + tile_size,
                     e[1] * tile_size + tile_size)
        if e[1] > 0:
            if grid[e[0]][e[1] - 1] != 1:
                stroke(cl[0], cl[1], cl[2])
